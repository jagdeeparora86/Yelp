...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, distance: Int?, categories: [String]?, deals: Bool?, offSet: Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
